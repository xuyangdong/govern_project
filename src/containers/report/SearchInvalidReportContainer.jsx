...
import { getInvalidReportList, searchReport } from '../../actions/report'
import { Input, Table } from 'antd'
import CommonButton from '../../components/common/Button'

class SearchInvalidReportContainer extends React.Component {
    state = {
        isLoading: false,
        reportNumber: '',
        productName: '',
    ...
    componentWillMount() {
        ...
        this.props.getInvalidReportList().then(res => this.setState({isLoading: false}))
    }
            ...
            <div className={styles.container}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.reportList}>
                        <Table
                            // onRowClick={this.handleCheckDetail}
                            loading={isLoading}
...
SearchInvalidReportContainer.contextTypes = {
...
const mapStateToProps = state => ({
	reportList: state.getIn(['report', 'invalidReportList']),
})

const mapDispatchToProps = dispatch => ({
    getInvalidReportList: bindActionCreators(getInvalidReportList, dispatch),
    // searchReport: bindActionCreators(searchReport, dispatch),
})

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SearchInvalidReportContainer))
